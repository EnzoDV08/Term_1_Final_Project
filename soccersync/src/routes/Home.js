              ...
              <div className="card-body">
                <div className="titleCon">
                  ...
                  <p className="info-text-2">
                    ...
                    Lucas, which began with the
                    <br /> eponymous 1977 film and quickly became a worldwide
                    pop-culture phenomenon.
                  </p>
                  <p className="description-text-2">
                    The franchise has expanded to various forms of media
                    including film, television series, novels, comics, and video
                    games.
                    <br /> It depicts the adventures of characters "a long time
                    ago in a galaxy far, far away",<br /> in which humans and
                    various species of aliens coexist with robots, or "droids",
                    who serve as sentient slaves and assistants to their owners.
                  </p>
